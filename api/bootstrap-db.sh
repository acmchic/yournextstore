...
for migration in mysql/init/001_schema.sql mysql/init/002_seed_catalog.sql mysql/init/003_gearment_catalog.sql mysql/init/004_catalog_color_sort_order.sql mysql/init/004_catalog_mockup_metadata.sql mysql/init/005_catalog_asset_placement.sql mysql/init/006_teebravo_brand.sql mysql/init/007_remove_unused_catalog_payload.sql mysql/init/008_catalog_asset_categories.sql mysql/init/009_catalog_material_json.sql mysql/init/010_checkout_stripe_shipping.sql mysql/init/011_pdp_delivery_estimate.sql; do
  version="${migration##*/}"
  version="${version%.sql}"
