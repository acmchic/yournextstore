...
## Google Merchant Center + Google Ads Compliance

Before changing product data, product pages, cart, checkout, legal/trust pages,
structured data, feeds, product images, or ad copy, read and follow
`docs/google-merchant-center-ads-checklist.md`.
...
- Keep contact, shipping, returns/refunds, privacy, terms, FAQ, and business
  ...
  explicitly.
- Merchant Center submission requires a real purchase path: add to cart,
  checkout, conventional payment method, full costs before purchase, and clear
  post-purchase conditions.
- POD apparel must avoid counterfeit goods, trademark confusion, copied artwork,
  fake affiliations, celebrity/IP bait, misleading claims, watermarked images,
  and inaccurate mockups.
