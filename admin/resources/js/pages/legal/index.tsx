    ...
    return (
        <div className="space-y-6 p-6">
            ...
            <p className="text-muted-foreground">
                Create shipping, returns, privacy and terms pages. Publish only
                verified business conditions. Uncheck Published to remove a page
                from the storefront.
            </p>
            <p className="text-sm">
                ...
                . Keep the double-brace fields in policy text so rates and terms
                ...
                >
                    ...
                    <label className="block">
                        ...
                        <Textarea
                            required
                            rows={18}
                            className="mt-2 min-h-72 font-mono text-sm leading-6"
                    ...
                    <label className="flex items-center gap-2 text-sm font-medium">
                        <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                                form.setData('published', checked === true)
                            }
                        />
                        <span>Published</span>
                    </label>
